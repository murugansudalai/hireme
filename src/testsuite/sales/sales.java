...
public class sales {
	...
	public static void navigate(){
		...
		try {
			...
			//select_max.sendKeys(price_max_value);

			
			for (WebElement option : options_max) {
			    if(price_max_value.equals(option.getText().toUpperCase())) {
			        option.click();   
			    }
			}
			...
			//wait.until(ExpectedConditions.presenceOfElementLocated(By.id(includeSSTC)));			
	        //JavascriptExecutor js = (JavascriptExecutor)driver;
	        //js.executeScript("arguments[0].click();", driver.findElement(By.id(includeSSTC)));			
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("[data-test='propertyCard-0']")));
			...
			System.out.println("Feture property is value is blank or" + featuredProperty1 );

			if (featuredProperty1.isEmpty()) {
				...
				driver.findElement(By.xpath("//*[@id=\"l-searchResults\"]/div[1]/div/div[1]/div[1]")).click();
